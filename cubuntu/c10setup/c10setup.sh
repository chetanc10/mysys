...
declare -a cutils=(vim cscope exuberant-ctags git at tree xpad minicom tftp-server lftp subversion meld ssh curl rar unrar vlc tomboy nmap artha skype youtube-dl gparted synaptic wifi-radar wireshark qemu-system-x86)
